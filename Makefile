...
BINARY_NAME?=kubetest2-lambdalabs
BINARY_PATH?=.
...
CGO_ENABLED=0
export PATH GOROOT CGO_ENABLED
...
deployer:
	BINARY_PATH=.
	BINARY_NAME=kubetest2-lambdalabs
	BUILD_FLAGS='-trimpath -ldflags="-buildid= -X=github.com/ameukam/kubetest2-lambdalabs/deployer.GitTag=$(COMMIT)"'
